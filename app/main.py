...
APP_VERSION = VERSION_FILE.read_text(encoding='utf-8').strip() if VERSION_FILE.exists() else '78.4.0'
...
app = FastAPI(
    title='TrazoCad',
    version=APP_VERSION,
    description='TrazoCad 78.4 OCR regional: lectura documental por regiones sobre la base segmentada para rótulo, notas y título.',
)
